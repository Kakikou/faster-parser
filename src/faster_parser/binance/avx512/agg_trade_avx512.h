/**
 * @file agg_trade_avx512.h
 * @author Kevin Rodrigues
 * @brief AVX-512 SIMD-optimized Binance aggregate trade parser
 * @version 1.0
 * @date 16/10/2025
 */

#ifndef FASTER_PARSER_AGG_TRADE_AVX512_H
#define FASTER_PARSER_AGG_TRADE_AVX512_H
...
#endif //FASTER_PARSER_AGG_TRADE_AVX512_H

/**
 * @file agg_trade_avx2.h
 * @author Kevin Rodrigues
 * @brief AVX2 SIMD-optimized Binance aggregate trade parser
 * @version 1.0
 * @date 16/10/2025
 */

#ifndef FASTER_PARSER_AGG_TRADE_AVX2_H
#define FASTER_PARSER_AGG_TRADE_AVX2_H
...
#endif //FASTER_PARSER_AGG_TRADE_AVX2_H

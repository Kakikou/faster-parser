...
namespace core::faster_parser::binance {
    ...
    public:
        ...
        template<BinanceFutureListener listener_t>
        static __attribute__((always_inline)) inline bool process_agg_trade(std::chrono::system_clock::time_point const &now, std::string_view raw, listener_t &listener) {
            // Message example: {"e":"aggTrade","E":123456789,"s":"BTCUSDT","a":5933014,"p":"0.001","q":"100","f":100,"l":105,"T":123456785,"m":true}
            return impl::process_agg_trade(now, raw, listener);
        }
    };

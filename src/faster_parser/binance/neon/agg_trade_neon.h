/**
 * @file agg_trade_neon.h
 * @author Kevin Rodrigues
 * @brief NEON SIMD-optimized Binance aggregate trade parser
 * @version 1.0
 * @date 16/10/2025
 */

#ifndef FASTER_PARSER_AGG_TRADE_NEON_H
#define FASTER_PARSER_AGG_TRADE_NEON_H
...
#endif //FASTER_PARSER_AGG_TRADE_NEON_H
